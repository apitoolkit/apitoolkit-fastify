...
var _APIToolkit_topic, _APIToolkit_pubsub, _APIToolkit_project_id, _APIToolkit_redactHeaders, _APIToolkit_redactRequestBody, _APIToolkit_redactResponseBody, _APIToolkit_fastify, _APIToolkit_startTimes, _APIToolkit_service_version, _APIToolkit_tags, _APIToolkit_debug, _APIToolkit_axios;
...
class APIToolkit {
    constructor(pubsub, topic, project_id, fastify, redactHeaders, redactReqBody, redactRespBody, service_version, tags, debug, monitorAxios) {
        ...
        _APIToolkit_axios.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _APIToolkit_axios, monitorAxios, "f");
        this.init = this.init.bind(this);
    }
    static NewClient({ apiKey, fastify, rootURL = "https://app.apitoolkit.io", redactHeaders = [], redactRequestBody = [], redactResponseBody = [], service_version = undefined, debug = false, tags = [], monitorAxios = undefined, }) {
        ...
        return new APIToolkit(pubsubClient, topic_id, project_id, fastify, redactHeaders, redactRequestBody, redactResponseBody, service_version, tags, debug, monitorAxios);
    }
    getStringValue(val) {
        if (!val)
            return "";
    ...
    init() {
        if (__classPrivateFieldGet(this, _APIToolkit_axios, "f")) {
            (0, apitoolkit_js_1.observeAxiosGlobal)(__classPrivateFieldGet(this, _APIToolkit_axios, "f"), undefined, __classPrivateFieldGet(this, _APIToolkit_redactHeaders, "f"), __classPrivateFieldGet(this, _APIToolkit_redactRequestBody, "f"), __classPrivateFieldGet(this, _APIToolkit_redactResponseBody, "f"), this);
        }
        ...
        __classPrivateFieldGet(this, _APIToolkit_fastify, "f").addHook("onError", async (_request, _reply, error) => {
            (0, apitoolkit_js_1.ReportError)(error);
        });
