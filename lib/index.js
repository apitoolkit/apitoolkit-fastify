...
var _APIToolkit_topic, _APIToolkit_pubsub, _APIToolkit_project_id, _APIToolkit_redactHeaders, _APIToolkit_redactRequestBody, _APIToolkit_redactResponseBody, _APIToolkit_fastify, _APIToolkit_startTimes, _APIToolkit_service_version, _APIToolkit_tags;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReportError = exports.obsAxios = void 0;
...
Object.defineProperty(exports, "obsAxios", { enumerable: true, get: function () { return apitoolkit_js_2.observeAxios; } });
Object.defineProperty(exports, "ReportError", { enumerable: true, get: function () { return apitoolkit_js_2.ReportError; } });
const uuid_1 = require("uuid");
class APIToolkit {
    constructor(pubsub, topic, project_id, fastify, redactHeaders, redactReqBody, redactRespBody, service_version, tags) {
    ...
    static NewClient({ apiKey, fastify, rootURL = "https://app.apitoolkit.io", redactHeaders = [], redactRequestBody = [], redactResponseBody = [], service_version = undefined, tags = [] }) {
    ...
    observeAxios(axiosInstance, urlWildcard, redactHeaders, redactRequestBody, redactResponseBody) {
        return obsAxios(axiosInstance, urlWildcard, redactHeaders, redactRequestBody, redactResponseBody, true, this);
    }
    init() {
        __classPrivateFieldGet(this, _APIToolkit_fastify, "f").addHook('preHandler', (request, _reply, done) => {
            ...
            apitoolkit_js_1.asyncLocalStorage.run(new Map(), () => {
                ...
                apitoolkit_js_1.asyncLocalStorage.getStore().set('AT_config', { tags: __classPrivateFieldGet(this, _APIToolkit_tags, "f"), serviceVersion: __classPrivateFieldGet(this, _APIToolkit_service_version, "f") });
